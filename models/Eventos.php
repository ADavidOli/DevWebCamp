...
{
    // primero instanciamos nuestra base de datos y tabla
    ...
    public $hora_id;
    public $ponente_id;
    // instanciamos nuestro contructor que devuelve nuestro arreglo para modelo
    //el constructor no es necesario cuando ya manejas un array.
